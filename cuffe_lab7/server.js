...
app.post("/Cart/", function (req,res) {
    ...
    var sqlsel = "select MAX(dbcartdailyid) as daymax from cartinfo WHERE DATE(dbcartdate) = CURDATE()";
    ...
    con.query(sql, function (err, data) {
        ...
        var sqlinscart = "INSERT INTO cartinfo (dbcartemp, dbcartdailyid, dbcartpickup, dbcartmade, dbcartdate) VALUES (?,?,?,?, now())";
...
app.post("/updatesingleemp", function (req, res, ){
    ...
    var sqlins = "UPDATE employeetable SET dbemployeeid = ?, dbemployeename = ?, dbemployeeemail = ?, dbemployeephone = ?, dbemployeesalary = ?, dbemployeemailer = ?, dbemployeetype = ? WHERE dbemployeekey = ?";
...
app.post("/updatesinglecust", function (req, res) {
    ...
    var crewards = req.body.upcustomerrewards;
    var ckey = req.body.upcustomerkey;

    var sqlins = "UPDATE customertable SET dbcustomername = ?, dbcustomeraddress = ?, dbcustomerzip = ?, dbcustomercredit = ?, dbcustomeremail = ?, dbcustomermember = ?, dbcustomerrewards = ? where dbcustomerid = ?";
    var inserts = [cname, caddress, czip, ccredit, cemail, cmember, crewards, ckey];
